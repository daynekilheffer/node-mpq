...
FileParser.prototype.parseMagic = function(context) {
	var self = this;
	var magic = context.toString();
	if (magic === 'MPQ\x1a') {
		self.emit('error.magic', 'MPQ\x1a is not yet implemented');
	} else if (magic === 'MPQ\x1b') {
		self.parseMPQbMagic(context);
	}
};

FileParser.prototype.parseMPQbMagic = function() {
	var self = this;
	read(self.fd, {
		position: 0,
...
FileParser.prototype.parseFileHeader = function() {
	var self = this;
	var offset = 0;
...
FileParser.prototype.parseUserData = function() {
	var self = this;
	read(self.fd, {
		position: 0,
...
FileParser.prototype.parseHashTable = function() {
	var self = this;
	this.parseTable('hash', function(returnData) {
		var hashTable = [];
...
FileParser.prototype.parseBlockTable = function() {
	var self = this;
	this.parseTable('block', function(returnData) {
		var blockTable = [];
		for (var i in returnData) {
			blockTable.push({
...
FileParser.prototype.parseTable = function(tableName, callback) {
	var self = this;
